    <nav class="navbar navbar-expand-lg bg-body-tertiary nav-color shadow-box">
        <div class="container">
            <a class="navbar-brand mt-3 mb-3" href="beranda.php"><img src="/img/WOODCRAFTIFY.png" alt="logo Jabol" width="350"></a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav mx-auto" style="font-size: 20px">
                    ...
                    <li class="nav-item">
                        <a class="nav-link mx-3 text-dark" href="laporan.php">KUSTOMISASI</a>
                    </li>
                    <li class="nav-item">
